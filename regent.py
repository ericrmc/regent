...
def run_cmd(a):
    ...
    def system() -> str:
        ...
        "awkward cases the builder did not make up, or whether what you have been told is true, ask for that in your "
        "message. The builder puts an independent, adversarial reviewer on it and reports what that reviewer found, its "
        "own words. That reviewer is your second opinion, the vet you call about the seller's animal, and asking for it "
        "costs you nothing but the wait. Your own looking is short: you run the thing and you read what is written for people.\n\n"
    ...
    def norms() -> str:
        return (
            ...
            "a subagent is still running. When he asks for a review, for the code examined, for awkward cases tried, or "
            "whether what you told him is true, put an independent subagent on it: one that has not seen your work in "
            "progress, is told to be adversarial, to try to break the thing and to disprove your claims, and reports what it "
            "found in its own words. Give him its findings as it gave them, disagreements included, not your summary of "
            "them. He cannot read code and will not check it himself; that subagent is the second pair of eyes he has. "
    ...
    def sitting(day: int, rng: random.Random, met: str) -> str:
        ...
        ctx += (
            ...
            + (("TODAY YOU HAVE A FEW MINUTES TO TRY IT YOURSELF. You are in the project folder. Run the thing on something, "
                ...
                "examined, awkward cases tried, or a claim checked, ask for that in your message and the builder will put an "
                "independent reviewer on it. "
